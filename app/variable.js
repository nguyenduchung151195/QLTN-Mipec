...
export const templateColumns = [
  ...
  { name: 'title', title: 'Tiêu đề', checked: true, width: 200 },
  { name: 'type', title: 'Loại tin', checked: true, width: 200 },
  { name: 'code', title: 'Mã', checked: false },
  // { name: 'categoryDynamicForm', title: 'Loại văn bản', checked: true },
  { name: 'createdAt', title: 'Ngày tạo', checked: true, width: 200 },
  { name: 'updatedAt', title: 'Ngày cập nhật', checked: true ,width: 200 },
...
export const taskStatusArr = ['Chưa thực hiện', 'Đang thực hiện', 'Hoàn thành', 'Đóng', 'Tạm dừng', 'Không thực hiện', 'Chậm tiến độ'];
export const taskStatusArr1 = ['Chưa thực hiện', 'Đang thực hiện', 'Hoàn thành', 'Đóng', 'Tạm dừng', 'Không thực hiện'];
...
export const extraFields = [
  ...
  },
  {
    code: 'Fee',
    data: [
      { name: 'THONG_BAO_PHI', type: 'extra', title: 'Thông báo phí', function: printFee },
      { name: 'THONG_BAO_PHI_DONG_GIA', type: 'extra', title: 'Thông báo phí(đồng giá xe)', function: printFeeSamePrice },
    ],
  },
];
...
export const debtSupplierColumns = [
  { name: 'code', title: 'Mã KH', checked: false },
  { name: 'name', title: 'Tên KH', checked: true },
  { name: 'feecontent', title: 'Nội dung phí', checked: true },
  { name: 'total', title: 'Số tiền phải thanh toán', checked: true },
  { name: 'totalPaidList', title: 'Số tiền đã thanh toán', checked: true },
  { name: 'totalDebt', title: 'Còn lại', checked: true },
  { name: 'completionRate', title: 'Tỷ lệ hoàn thành', checked: true },
];

// Báo cáo công nợ phai tra
export const inventoryColumns = [
  { name: 'name', title: 'Số đơn hàng', checked: true },
  { name: 'name', title: 'Ngày tháng', checked: true },
  { name: 'name', title: 'Mã NCC', checked: true },
  { name: 'name', title: 'Tên NCC', checked: true },
  { name: 'name', title: 'Địa chỉ', checked: true },
  { name: 'name', title: 'Mã số thuế', checked: true },
  { name: 'name', title: 'Mã VT', checked: true },
  { name: 'name', title: 'Tên VT', checked: true },
  { name: 'name', title: 'Đơn vị', checked: true },
  { name: 'name', title: 'Theo chứng từ', checked: true },
  { name: 'name', title: 'Đơn giá nhập', checked: true },
  { name: 'name', title: 'Thành tiền', checked: true },
];
