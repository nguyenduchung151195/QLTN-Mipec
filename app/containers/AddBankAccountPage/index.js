...
function AddBankAccountPage(props) {
    ...
    const handleChange = (e) => {
        ...
        setLocalState({
            ...localState, [e.target.name]: value
        })
    }
    const onSave = () => {
        const body = {
    ...
    return (
        <>
            ...
            <Grid container spacing={8}>
                ...
                <Grid item xs={4}>
                    <CustomInputBase label={'Tên tài khoản'} value={localState.name ? localState.name : null} name="name" onChange={handleChange} />
                </Grid>
                {/* {id === 'add' ? */}
                {/* <Grid item xs={4}>
                    <TextField
                ...
                <Grid item xs={4}>
                    <CustomInputBase label={'Số tài khoản'} value={localState.accountNumber ? localState.accountNumber : null} name="accountNumber" onChange={handleChange} />
                </Grid>
                <Grid item xs={4}>
