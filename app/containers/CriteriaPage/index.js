...
export class CriteriaPage extends React.Component {
  ...
  render() {
    const { criteriaPage, intl } = this.props;
    ...
    console.log("fdsaaaa", this.props)
    return (
      <div>
        ...
        >
          ...
          <DialogActions>
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
              ...
              <Button  onClick={() => 
            // eslint-disable-next-line no-sequences
            this.props.mergeData({ openDialog: false })} variant="outlined" color="secondary">
                Hủy
              </Button>
            </div>
          </DialogActions>
        </Dialog>
        <SwipeableDrawer anchor="left" onClose={() => this.props.mergeData({ openDrawer: false })} open={openDrawer} width={window.innerWidth - 260}>
