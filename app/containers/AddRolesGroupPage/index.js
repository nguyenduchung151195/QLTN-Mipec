...
export class AddRolesGroupPage extends React.Component {
    ...
    return (
      <div>
        ...
        <Paper className={classes.paper}>
          ...
          <TextField value={code} className={classes.textField} name="code" onChange={this.handleChange} label="Mã vai trò" />
  ...
  onSubmit = () => {
    ...
    if (roleName && code) {
      ...
      this.props.onChangeSnacker({ variant: 'error', message: 'Cập nhật thất bại 1', status: true });
    }
  };
