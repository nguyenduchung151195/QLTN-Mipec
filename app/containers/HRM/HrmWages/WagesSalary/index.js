 ...
 */
 ...
 function WageSalarySalary(props) {
   const { mergeData, wageSalary, onCreateWageSalary, onUpdateWageSalary, onDeleteWageSalary, id: hrmEmployeeId, dashboardPage, getAllSalaryFormula, onGetSalaryFormulaAttributes, onChangeSnackbar } = props;
   ...
   const addItem = () => (
     <Add style={{ color: 'white' }} onClick={handleOpenWageSalaryDialog}>
       Open Menu
     </Add>
   );
   ...
   return (
     <div>
       ...
       <SwipeableDrawer anchor="right" onClose={handleCloseDetailWageSalaryDialog} open={openDetail} width={window.innerWidth - 260}>
         <div>
           <WagesSalaryDetail dashboardPage={props.dashboardPage} formulaAttributes={formulaAttributes} selectedWageSalary={dataDetail} callback={callbackDetail} />
         </div>
       </SwipeableDrawer>
