...
function AddWageSalary(props) {
  ...
  const handleInputChangeEmp = useCallback(e => {
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent style={{ width: 600 }}>
          <Grid container direction="row" alignItems="flex-start" spacing={8}>
            <Grid item xs={12}>
              <Department onChange={handeChangeDepartment} department={localState.organizationUnitId} isHrm employee={localState.hrmEmployeeId} profile={profile} moduleCode="HrmOverTime"/>
            </Grid>
