...
function ConfigSalaryFormula(props) {
  ...
  const { onDelete, salaryFormula, onSave, handleSelectSalaryFormula, attributeFormula, listAttributeFormula, addSalaryFormulaSuccess, updateSalaryFormulaSuccess, deleteSalaryFormulaSuccess,
    onUpdateAttribute, addAttributeFormulaSuccess, onChangeSnackbar, attributeFormulaId, addSingleAttributeFormula, updateSingleAttributeFormula } = props;
      ...
      <Grid>
        ...
        <SwipeableDrawer anchor="right" onClose={() => setDialog(false)} open={dialog}  width={window.innerWidth - 260}>
          <div style={{ padding: '15px' }}>
            <DetailSalaryFormula attributeFormula={attributeFormula} onUpdateAttribute={onUpdateAttribute} listAttributeFormula={listAttributeFormula} attributeFormulaId={attributeFormulaId} addSingleAttributeFormula={addSingleAttributeFormula} updateSingleAttributeFormula={updateSingleAttributeFormula} />
          </div>
        </SwipeableDrawer>
      </Grid>
    </React.Fragment >
