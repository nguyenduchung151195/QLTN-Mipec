...
import { CREATE_RECRUITMENTMANAGEMENT, UPDATE_RECRUITMENTMANAGEMENT, DELETE_RECRUITMENTMANAGEMENT, GET_HUMAN_RESOURCE, GET_COUNT_HRM_BY_ROLE, GET_POSITION_VACATION } from './constants';
...
export function* createRecruitmentManagement(action) {
  try {
    ...
    console.log(err,'pppppppppppppp')
