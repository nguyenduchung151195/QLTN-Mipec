...
function recruitmentManagementPageReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case UPDATE_RECRUITMENTMANAGEMENT:
      return state.set('isLoading', true).set('updateRecruitmentManagementSuccess', null);
    case UPDATE_RECRUITMENTMANAGEMENT_SUCCESS:
      return state.set('isLoading', false).set('updateRecruitmentManagementSuccess', true);
    case UPDATE_RECRUITMENTMANAGEMENT_FAILURE:
      return state.set('isLoading', false).set('updateRecruitmentManagementSuccess', false);
