  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.startDate} name="startDate" value={localState.startDate} onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.endDate} value={localState.endDate} name="endDate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title["position.title"]} value={localState.position} name="position" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.positionSpeci} value={localState.positionSpeci} name="positionSpeci" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.costs} value={localState.costs} name="costs" onChange={handleInputChange}
