  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.startDate} value={localState.startDate} name="startDate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.positionConcur} value={localState.positionConcur} name="positionConcur" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.note} rows={4} value={localState.note} name="note" onChange={handleInputChange}
