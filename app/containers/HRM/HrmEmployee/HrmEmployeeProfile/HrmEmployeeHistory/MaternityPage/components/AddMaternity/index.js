  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.duedate} value={localState.duedate} name="duedate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.backDate} value={localState.backDate} name="backDate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <Typography>
            <Checkbox color="primary" checked={localState.adoptedChild ? localState.adoptedChild : false} onChange={e => handeCheckbox('adoptedChild', e.target.checked)} />
            Nuôi con nuôi
          </Typography>
        </Grid>
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.ageChild} value={localState.ageChild} name="ageChild" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.fromMonth} value={localState.fromMonth} name="fromMonth" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.toMonth} value={localState.toMonth} name="toMonth" onChange={handleInputChange}
      ...
      <Grid container spacing={8}>
        ...
        <Typography style={{ width: '23%', marginLeft: 10 }}>
          <Checkbox color="primary" checked={localState.keepHealth ? localState.keepHealth : false} onChange={e => handeCheckbox('keepHealth', e.target.checked)} />
          Có nghỉ dưỡng sức
        </Typography>

        <Grid item xs={4}>
          <CustomInputBase type="date" label={name2Title.atHome} value={localState.atHome} name="atHome" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.nameChild1} value={localState.nameChild1} name="nameChild1" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.nameChild2} value={localState.nameChild2} name="nameChild2" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.nameChild3} value={localState.nameChild3} name="nameChild3" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.nameChild4} value={localState.nameChild4} name="nameChild4" onChange={handleInputChange}
