...
function MaternityPage(props) {
  const { maternityPage, onCreateMaternity, onUpdateMaternity, onDeleteMaternity, id: hrmEmployeeId } = props;
  ...
  const addItem = () => (
    <Add style={{ color: 'white' }} onClick={handleOpenMaternityDialog}>
      Open Menu
    </Add>
  );
