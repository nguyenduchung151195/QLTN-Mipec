  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomDatePicker label={name2Title.startDate || "Chọn ngày"} value={localState.startDate} name="startDate" onChange={e => handleInpuDate(e,  true )}
        ...
        <Grid item xs={4}>
          <CustomDatePicker label={name2Title.endDate || "Chọn ngày"} value={localState.endDate} name="endDate" onChange={e => handleInpuDate(e,  false )}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.totalDate} value={localState.totalDate} name="totalDate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.bonusDate} value={localState.bonusDate} name="bonusDate" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.explain} value={localState.explain} name="explain" onChange={handleInputChange}
