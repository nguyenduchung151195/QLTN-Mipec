  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        <Grid item xs={6}>
          <MuiPickersUtilsProvider utils={MomentUtils}>
            <DatePicker
              ...
              variant="outlined"
              fullWidth
              label={name2Title.startDate || 'Chọn ngày'} value={localState.startDate} name="startDate" onChange={e => handleInputChange(e, true)}
        ...
        <Grid item xs={6}>
          <MuiPickersUtilsProvider utils={MomentUtils}>
            <DatePicker
              ...
              format="DD/MM/YYYY"
              variant="outlined"
              fullWidth label={name2Title.endDate || 'Chọn ngày'} value={localState.endDate} name="endDate" onChange={e => handleInputChange(e, false)}
        ...
        <Grid item xs={12}>
          <CustomInputBase label={name2Title.note} row={2} value={localState.note} name="note" onChange={handleInputChange}
