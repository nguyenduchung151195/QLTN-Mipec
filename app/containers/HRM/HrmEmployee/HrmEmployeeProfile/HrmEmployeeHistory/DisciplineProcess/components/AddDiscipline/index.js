  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.signer} value={localState.signer} name="signer" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.form} value={localState.form} name="form" onChange={handleInputChange}
...
export default memo(DisciplineProcess);
