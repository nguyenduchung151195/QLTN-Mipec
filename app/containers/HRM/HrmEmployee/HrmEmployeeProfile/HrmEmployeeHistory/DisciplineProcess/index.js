...
function DisciplinePage(props) {
  const { disciplinePage, onCreateDiscipline, onUpdateDiscipline, onDeleteDiscipline, id: hrmEmployeeId } = props;
  ...
  const addItem = () => (
    <Add style={{ color: 'white' }} onClick={handleOpenDisciplineDialog}>
      Open Menu
    </Add>
  );
