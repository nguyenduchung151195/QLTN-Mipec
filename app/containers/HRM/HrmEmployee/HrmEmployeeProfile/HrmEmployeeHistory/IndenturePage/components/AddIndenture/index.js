  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        ...
        <Grid item xs={4}>
          <CustomDatePicker  label={name2Title.signDate || "Chọn ngày"} value={localState.signDate} name="signDate"  onChange={e => handleInputSignDate(e,  true )}
        ...
        <Grid item xs={4}>
          <CustomInputBase select label={name2Title["signer.title"]} value={localState.signer} name="signer" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomDatePicker  label={name2Title.startDate || "Chọn ngày"} value={localState.startDate} name="startDate" onChange={e => handleInputChange(e,  true )}
        ...
        <Grid item xs={4}>
          <CustomDatePicker  label={name2Title.endDate || "Chọn ngày"} value={localState.endDate} name="endDate" onChange={e => handleInputChange(e,  false )}
        ...
        <Grid item xs={4}>
          <Department onChange={handeChangeDepartment} department={localState.organizationUnit} disableEmployee profile={profile} moduleCode="ContractProcess" />
        ...
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.level} value={localState.level} name="level" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.ratio} value={localState.ratio} name="ratio" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.title} value={localState.title} name="title" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase type="number" label={name2Title.salary} value={localState.salary} name="salary" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.allowance} value={localState.allowance} name="allowance" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.locationWork} value={localState.locationWork} name="locationWork" onChange={handleInputChange}
