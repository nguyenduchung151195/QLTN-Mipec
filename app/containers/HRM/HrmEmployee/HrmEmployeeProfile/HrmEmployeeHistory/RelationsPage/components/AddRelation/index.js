  ...
  return (
    <>
      ...
      <Grid container spacing={8}>
        <Grid item xs={12}>
          <CustomInputBase label={name2Title.relationship} value={localState.relationship} name="relationship" onChange={handleInputChange}
        ...
        <Grid item xs={12}>
          <CustomInputBase label={name2Title.fullName} value={localState.fullName} name="fullName" onChange={handleInputChange}
          ...
          <Typography>
            ...
            <Checkbox color="primary" checked={localState.emergencyContact ? localState.emergencyContact : false} onChange={e => handleCheckbox('emergencyContact', e.target.checked)} />
          </Typography>
        </Grid>
        <Grid item xs={4}>
          <CustomInputBase
        ...
        <Grid item xs={4}>
          <CustomDatePicker label={name2Title.birthDay || "Chọn ngày"} value={localState.birthDay} name="birthDay" onChange={e => handleInputChange(e,  true )}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.phoneNumber} value={localState.phoneNumber} name="phoneNumber" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.address} value={localState.address} name="address" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.relaHousehold} value={localState.relaHousehold} name="relaHousehold" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.papersType} value={localState.papersType} name="papersType" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.taxCode} value={localState.taxCode} name="taxCode" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.job} value={localState.job} name="job" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.nationality} value={localState.nationality} name="nationality" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <CustomInputBase label={name2Title.bookNumber} value={localState.bookNumber} name="bookNumber" onChange={handleInputChange}
        ...
        <Grid item xs={4}>
          <Typography>
            ...
            <Checkbox color="primary" checked={localState.familyCircumstances ? localState.familyCircumstances : false} onChange={e => handleCheckbox('familyCircumstances', e.target.checked)} />
          </Typography>
        </Grid>
      </Grid>
...
export default memo(AddRelation);
