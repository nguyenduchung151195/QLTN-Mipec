    ...
    return (
      <div>
        <VerticalTabs>
          ...
          <VerticalTab style={{ textAlign: 'left', textTransform: 'none' }} label="Báo cáo công nợ phải thu" onClick={this.onLiabiliti} />
          <VerticalTab style={{ textAlign: 'left', textTransform: 'none' }} label="Báo cáo tổng hợp công nợ phải thu theo khách hàng/ khu vực " />
          <VerticalTab style={{ textAlign: 'left', textTransform: 'none' }} label="Báo cáo tổng hợp doanh thu theo khách hàng/ khu vực" />
          <VerticalTab style={{ textAlign: 'left', textTransform: 'none' }} label="Báo cáo công nợ phải trả" />
        </VerticalTabs>
