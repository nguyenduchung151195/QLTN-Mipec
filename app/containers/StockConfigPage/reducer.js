...
function stockConfigPageReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case GET_ALL_TRADEMARKS:
      return state
        .set('loading', true)
        .set('success', false)
        .set('error', false);

    case GET_ALL_TRADEMARKS_SUCCESS:
      return state
        .set('loading', false)
        .set('success', false)
        .set('successCreate', false)
        .set('error', false)
        .set('trademarks', action.data);
    case ADD_TRADEMARK:
      return state
        .set('loading', false)
        .set('success', false)
        .set('trademarkAdded', -1)
        .set('error', false)
        .set('body', action.body);
    ...
    case DELETE_TRADEMARKS:
      return state
        ...
        .set('error', false)
        .set('body', action.body);
    case DELETE_TRADEMARKS_SUCCESS:
      return state
        .set('loading', false)
        .set('callAPIStatus', 1)
        .set('notiMessage', action.message)
