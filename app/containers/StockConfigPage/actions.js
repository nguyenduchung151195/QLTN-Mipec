...
import {
  ...
  GET_ALL_TRADEMARKS,
  GET_ALL_TRADEMARKS_SUCCESS,
  DELETE_TRADEMARKS,
  DELETE_TRADEMARKS_FAIL,
  DELETE_TRADEMARKS_SUCCESS,
  ADD_TRADEMARK,
  ADD_TRADEMARK_FAIL,
...
// Thương hiệu
export function getAllTrademarksAction() {
  return {
    type: GET_ALL_TRADEMARKS,
  };
}
export function getAllTrademarksSucsessAction(data) {
  return {
    type: GET_ALL_TRADEMARKS_SUCCESS,
    data,
  };
}
export function addTrademarkAction(body) {
  return {
    type: ADD_TRADEMARK,
    body,
  };
}
export function addTrademarkSuccessAction(data, message) {
  return {
...
export function addTrademarkFailAction(err, message) {
  return {
    type: ADD_TRADEMARK_FAIL,
    err,
    message,
  };
}
export function updateTrademarkAction(body) {
  return {
    type: UPDATE_TRADEMARK,
    body,
  };
}
export function updateTrademarkSuccessAction(data, message) {
  return {
...
export function updateTrademarkFailAction(err, message) {
  return {
...
export function deleteTrademarksAction(ids) {
  return {
    type: DELETE_TRADEMARKS,
    ids,
  };
}
export function deleteTrademarksSucsessAction(data, message) {
  return {
    type: DELETE_TRADEMARKS_SUCCESS,
    data,
    message,
  };
}
export function deleteTrademarksFailAction(data, message) {
  return {
    type: DELETE_TRADEMARKS_FAIL,
    data,
    message,
  };
}
