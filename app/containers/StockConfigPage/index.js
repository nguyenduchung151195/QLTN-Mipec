...
import {
  ...
  getAllTrademarksAction,
  addTrademarkAction,
  deleteTrademarksAction,
  updateTrademarkAction,
} from './actions';
...
export class StockConfigPage extends React.Component {
  state = {
    value: Number(JSON.parse(localStorage.getItem('stockConfig'))),
    listUnits: [],
    listServices: [],
    listTrademark: [],
    listCategories: [],
  ...
  componentWillUpdate(props) {
    ...
    this.state.listTrademark = stockConfigPage.trademarks;
  ...
  callBack = (cmd, data) => {
    ...
    switch (cmd) {
      ...
      case 'add-trademark': {
        this.props.onAddTrademark(data);
        break;
      }
      case 'update-trademark': {
        this.props.onUpdateTrademark(data);
        break;
      }
      case 'delete-trademark': {
        this.props.onDeleteTrademarks(data);
      ...
      <div>
        ...
        <Paper className={classes.paper}>
          ...
          >
            ...
            {/* Ẩn dịch vụ, xuất xứ, thương hiệu theo yêu cầu của test */}
            ...
            {/* <Tab disableRipple classes={{ root: classes.tabRoot, selected: classes.tabSelected }} label="Thương hiệu" /> */}
          </Tabs>
          <SwipeableViews
          ...
          {/* Ẩn dịch vụ, xuất xứ, thương hiệu theo yêu cầu của test */}
            ...
            {/* <TabContainer dir={theme.direction}>
              {this.state.listServices ? <Services name="dịch vụ" funcName="service" callBack={this.callBack} data={this.state.listServices} /> : ''} 
            </TabContainer> */}
            <TabContainer dir={theme.direction}>
            ...
            <TabContainer dir={theme.direction}>
              {Array.isArray(this.state.listTrademark) ? (
                <Services name="thương hiệu" funcName="trademark" callBack={this.callBack} data={this.state.listTrademark} />
              ) : (
                ''
              )}
            </TabContainer> */}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    onGetTrademarks: () => {
      dispatch(getAllTrademarksAction());
    },
    onAddTrademark: data => {
      dispatch(addTrademarkAction(data));
    },
    onUpdateTrademark: Trademark => {
      dispatch(updateTrademarkAction(Trademark));
    },
    onDeleteTrademarks: TrademarkIds => {
      dispatch(deleteTrademarksAction(TrademarkIds));
    },
  };
}
