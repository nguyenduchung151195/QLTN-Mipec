        ...
        <Grid container>
          <Grid item sm={6}>
            ...
            <div style={{ maxHeight: '900px', overflowY: 'auto' }}>
              <div style={{ display: 'flex', backgroundColor: '#fff', margin: '20px', border: '1px solid #e0e0eb', borderRadius: '5px', padding: '20px' }}>
                <Avatar style={{ width: 40, height: 40, display: 'inline-block' }} src={this.props.profile ? this.props.profile.avatar : null} />
                <div style={{ padding: '10px', marginLeft: '10px', borderRadius: '20px', backgroundColor: '#e0e0eb', width: '100%'}} onClick={this.Reply}>Chia sẻ cảm xúc suy nghĩ với mọi người!</div>
                {/* <TextField
                ...
                <div style={{ border: '1px solid #e0e0eb', backgroundColor: '#fff', borderRadius: '5px', margin: '20px', padding: '20px' }}>
                  <div style={{ display: 'flex', justifyContent: 'flex-start' }}>
                    <Avatar
                      ...
                      src={it.createdBy ? it.createdBy.avatar : null}
                    />
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ cursor: 'pointer', color: Array.isArray(it.countLike) && it.countLike.find(i => this.props.profile && i === this.props.profile._id) ? '#006edc' : '' }} onClick={() => {
                  ...
                  {this.state.indexShow === index ? (
                    <>
                      <hr style={{ border: '1px solid #e0e0eb', marginTop: '10px', marginBottom: '10px' }} />
                      <Comment code="NewsFeed" id={it._id} onCommentCreate={() => {
                        const currNews = this.state.newfeed;
                        const newNews = currNews[index];
              ...
              <Grid item sm={6} style={{ padding: '0 10px' }}>
                <div style={{ padding: '10px', backgroundColor: '#fff', borderRadius: '5px', height: '100%' }}>
                  ...
                  <div style={{ display: 'flex' }}>
                    <div>
                      <Avatar
                        src={peoples.length ? peoples[0].avatar : ''}
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', marginTop: 20 }}>
                    {peoples.map(p => (
                      <Avatar src={p.avatar} style={{ display: 'inline-block', border: '1px solid #e2e2e2' }} />
                    ))}
                  </div>
                </div>
              </Grid>
