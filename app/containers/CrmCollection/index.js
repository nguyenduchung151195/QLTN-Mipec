...
class CrmCollection extends React.Component {
  ...
  render() {
    ...
    // console.log("fdfdsdfsf", this.props)
    return (
      <div>
        <Helmet>
          <title>CRM</title>
        </Helmet>
        <AppBar style={{ zIndex: 1 }} position="relative" color="default">
          <Tabs
            style={{ width: '95%' }}
          ...
          <Link to="/crm/ ">
            <Fab onClick={this.handleClick} style={{ position: 'absolute', right: '5px', top: 5 }} color="primary" size="small" history>
              <Add />
            </Fab>
          </Link>
        </AppBar>
