...
import { TextValidator, TextField, Autocomplete, FileUpload, KanbanStep } from 'components/LifetekUi';
...
import { convertStrToSlug } from '../../utils/common';
...
export class AddCustomerPage extends React.Component {
  ...
  addItem = code => {
    const dataRender = JSON.parse(localStorage.getItem('crmSource')).find(item => item.code === code);
          ...
          <div>
            ...
            <Paper className={classes.breadcrumbs} style={{ display: 'none' }}>
              <Breadcrumbs aria-label="Breadcrumb">
                ...
                <Link style={{ color: '#0795db', textDecoration: 'none' }} to="/tower/Customer">
                      ...
                      <div style={{ display: 'flex' }}>
                        ...
                        {/* <a href={this.state.facebook}>
                            <img
                              ...
                              src="https://media.apnarm.net.au/media/images/2017/06/21/facebook-icon-preview-1-400x400-zpj7egf8qw7w6qn4go2_ct300x300.png"
                              alt="Anh cua LIFETEK-KHUONG"
                            />
                          </a> */}
                      </div>
                    </div>
  ...
  onSave = () => {
    ...
    if (Object.keys(messages).length === 0) {
      ...
      Array.isArray(keys) &&
        keys.map((x, i) => {
          this.props.onChangeSnackbar({ status: true, message: messages[x], variant: 'error' });
        });
    }
  };
