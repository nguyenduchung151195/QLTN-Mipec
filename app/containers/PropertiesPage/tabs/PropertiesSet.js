    ...
    return (
      <div style={{ width: '100%' }}>
        ...
        <GridUI item md={12} container style={{ height: 40, marginBottom: 10 }}>
          {/* <GridUI item md={1} container justify="flex-start">
            {this.state.selected.length !== 0 ? (
              <Fab size="small" title="Xóa mục đã chọn" style={{ marginLeft: 10, color: '#fff' }} color="secondary" onClick={this.handleDeletes}>
                <Delete />
              </Fab>
            ) : null}
          </GridUI> */}
