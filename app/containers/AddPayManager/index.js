        ...
        {tab === 3 ? (
          <div>
            ...
            <div>
              ...
              direction="row"
              justify="flex-end" spacing={16}>
                <Grid item md={2}>
                  <CustomInputBase select label="Khách hàng" onChange={this.handleChangeFilter} name="groupCustomer" value={this.state.groupCustomer} />
                </Grid>
                <Grid item md={2}>
                    <CustomInputBase label="Từ ngày" type="date" name="startDate" value={this.state.startDate} onChange={this.handleChangeFiler} />
                  </Grid>
                  <Grid item md={2}>
                    <CustomInputBase label="Đến ngày" type="date" name="endDate" value={this.state.endDate} onChange={this.handleChangeFiler} />
                  </Grid>
              </Grid>
