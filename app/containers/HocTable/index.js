                    ...
                    <div className="text-right align-item-center">
                      ...
                      {selection.length > 0 && functionAllow.includes('DELETE') ? (
                        ...
                        <div>
                          ...
                          {this.props.newSettingBar ? this.props.newSettingBar.map(item => (item ? <Fab  className="mx-2"
                                size="small"
                                color="primary"
                                aria-label="History"><Link to={`${this.getUrl()}/history`}>{item}</Link></Fab> : null)) : null}
