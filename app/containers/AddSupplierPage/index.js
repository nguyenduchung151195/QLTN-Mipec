...
class AddSupplierPage extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      // ],
      supplierColumns: JSON.parse(localStorage.getItem('viewConfig')).find(
        item => item.code === 'Supplier',
  ...
  onSave = () => {
    // this.setState({
    //   localMessages: messages2,
    // });
    //   console.log(this.state)
    const props = this.props.addSupplierPage;
    //Check email
    const regex = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    if (props.email !== '' && !regex.test(props.email)) {
    ...
    if (props.website !== '' && !regexDomain.test(props.website)) {
      this.props.onChangeSnackbar({
        status: true,
    ...
    const attributes = {};
    Object.keys(props.listAtt).forEach(item => {
      if (this.props.addSupplierPage[item].length)
        attributes[item] = this.props.addSupplierPage[item];
    });
  ...
  handleChangeDate = (e, name) => {
    ...
    this.props.mergeData({ [names]: value });
  };
  handleChange = name => e => {
      ...
      <div>
        ...
        {/* <Paper style={{ marginBottom: '20px' }}>
          <Breadcrumbs style={{ padding: 10 }} aria-label="Breadcrumb">
            ...
            <Link style={{ color: '#0795db', textDecoration: 'none' }} to="/tower/config">
              CRM
            </Link>
            <Link style={{ color: '#0795db', textDecoration: 'none' }} to="/tower/vendor">
        ...
        <ValidatorForm onSubmit={this.onSave}>
          ...
          <CustomAppBar
            title={
              id === 'add'
                ? `${intl.formatMessage(
                    messages.themmoi || { id: 'themmoi', defaultMessage: 'Thêm mới nhà cung cấp' },
                  )}`
                : `${intl.formatMessage(
                    messages.chinhsua || {
                      id: 'chinhsua',
                      defaultMessage: 'cập nhật nhà cung cấp',
                    },
                  )}`
            }
          ...
          >
            <GridUI container item md={12}>
              <GridUI item md={6}>
                ...
                >
                  ...
                  {intl.formatMessage(
                    messages.thongtin || { id: 'thongtin', defaultMessage: 'thongtin' },
                  )}
                  <span
                    style={{
                      color: '#A4A4A4',
                  ...
                  >
                    {intl.formatMessage(
                      messages.truongcannhap || {
                        id: 'truongcannhap',
                        defaultMessage: 'truongcannhap',
                      },
                    )}
                  </span>
                </Typography>
                ...
                <CustomInputBase
                  ...
                  label={names.phone}
                  error={localMessages && localMessages.phone}
                  helperText={localMessages && localMessages.phone}
                ...
                <CustomDatePicker
                  ...
                  onChange={e => this.handleChangeDate(e, 'createdAtSupplier')}
                  ...
                  required={checkRequired.createdAtSupplier}
              ...
              <GridUI item md={6}>
                <div style={{ display: 'grid', justifyContent: 'center' }}>
                  ...
                  >
                    ...
                    {intl.formatMessage(
                      messages.chonanh || { id: 'chonanh', defaultMessage: 'chonanh' },
                    )}
                  </Typography>
                  <Avatar
                    alt="Ảnh đại diện"
                    src={
                      props.addSupplierPage.logoURL || props.addSupplierPage.logo || avatarDefault
                    }
                    style={{
                      marginTop: 20,
                      width: 200,
                  ...
                  <label htmlFor="contained-button-file">
                    ...
                    >
                      {intl.formatMessage(
                        messages.themanh || { id: 'themanh', defaultMessage: 'themanh' },
                      )}
                    </Button>
                  </label>
                </div>
                ...
                >
                  <Tab
                    ...
                    label={intl.formatMessage(
                      messages.nguoidaidien || {
                        id: 'nguoidaidien',
                        defaultMessage: 'nguoidaidien',
                      },
                    )}
                  />
                  <Tab
                    disableRipple
                    label={intl.formatMessage(
                      messages.phanloaikhachhang || {
                        id: 'phanloaikhachhang',
                        defaultMessage: 'phanloaikhachhang',
                      },
                    )}
                  />
                </Tabs>
                ...
                >
                  <TabContainer>
                    ...
                    <CustomInputBase
                      ...
                      error={localMessages && localMessages.representativePhone}
                      helperText={localMessages && localMessages.representativePhone}
            ...
            <GridUI item sm={12}>
              ...
              >
                <Edit style={{ fontSize: '20px', marginBottom: 7 }} />{' '}
                {intl.formatMessage(
                  messages.thongtindaumoi || {
                    id: 'thongtindaumoi',
                    defaultMessage: 'thongtindaumoi',
                  },
                )}
              </Typography>
              <DataGrid
                id="gridContainer"
                dataSource={this.props.addSupplierPage.clueInformation}
                ders
                repaintChangesOnly
              >
                ...
                <Editing
                  ...
                  mode="cell"
                  texts={{
                    confirmDeleteMessage: intl.formatMessage(
                      messages.xoa || { id: 'xoa', defaultMessage: 'Xóa' },
                    ),
                  }}
                  allowUpdating
                  allowDeleting
