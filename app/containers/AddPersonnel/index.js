...
export class AddPersonnel extends React.Component {
  ...
  render() {
    const id = this.props.id ? this.props.id : this.props.match.params.id;
    const { addPersonnel, classes, intl } = this.props;
    const {
      automatic,
      departments,
      openDrawer,
    ...
    return (
      <div className={classes.root}>
        {/* <AppBar className={this.props.id === undefined ? classes.HearderappBarAddPersonelKanban : classes.HearderappBarAddPersonel}>
          <Toolbar>
            <IconButton
              // className={id !== 'add' ? '' : ''}
              className={this.props.id === undefined ? classes.BTNaddPersonelKanban : classes.BTNaddPersonel}
              color="inherit"
              variant="contained"
              onClick={this.hanhdleClick}
              aria-label="Close"
            >
              <Close />
            </IconButton>
            ...
            <Button variant="outlined" color="inherit" onClick={this.onSubmit}>
        ...
        {tab === 2 ? (
          <Paper>
            ...
            <SwipeableDrawer
              ...
              width={window.innerWidth - 260}
            >
              <IndenturePage id={id} codeContract={`${addPersonnel.name}_${addPersonnel.code}`} />
            </SwipeableDrawer>
            <SwipeableDrawer
              anchor="right"
            ...
            <SwipeableDrawer
              ...
              width={window.innerWidth - 260}
            >
              <SabbaticalPage id={id} fileName={`${addPersonnel.name}_${addPersonnel.code}`} />
            </SwipeableDrawer>
            <SwipeableDrawer
              anchor="right"
        ...
        {tab === 3 ? (
          <Paper>
            ...
            <SwipeableDrawer
              ...
              width={window.innerWidth - 260}
            >
              <DismissedPage id={id} fileName={`${addPersonnel.name}_${addPersonnel.code}`} />
            </SwipeableDrawer>
            <SwipeableDrawer
              anchor="right"
  ...
  onSubmit = () => {
    ...
    const data = {
      ...
      startDate: addPersonnel.startDate,
