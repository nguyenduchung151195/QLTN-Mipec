...
export class ListOfDepartmentPage extends React.Component {
    ...
    if (props !== this.props) {
      ...
      arrDepartment.forEach(unit => {
        const newItem = {
          ...
          duty: unit.duty,
          inchargeEmail: unit.inchargeEmail,
          ccEmails: unit.ccEmails,
          bccEmails: unit.bccEmails,
          note: unit.note,
        ...
        >
          ...
          <DialogContent className={classes.wrapContentDialog}>
            ...
            <TextField
              ...
              name="inchargeEmail"
              onChange={this.handleChange}
              value={this.state.inchargeEmail}
            />
            <TextField
              label="CC email(Danh sách mail cách nhau bằng dấu phảy)"
              className={classes.textField2}
              name="ccEmails"
              onChange={this.handleChange}
            ...
            />
              <TextField
              label="BCC email(Danh sách mail cách nhau bằng dấu phảy)"
              className={classes.textField2}
              name="bccEmails"
              onChange={this.handleChange}
  ...
  handleEditDepartment = id => {
    ...
    this.setState({
      ...
      inchargeEmail: currentDepart.inchargeEmail,
      ccEmails: currentDepart.ccEmails,
      bccEmails: currentDepart.bccEmails,
