...
export class WagesPage extends React.Component {
  ...
  render() {
    ...
    const { wagesPage, intl, reload, dashboardPage } = this.props;
    const roleCode0 = this.props.dashboardPage.role.roles.find(item => item.codeModleFunction === "HrmTimekeepingTable");
    const roleCode1 = this.props.dashboardPage.role.roles.find(item => item.codeModleFunction === "HrmOverTime" );
    const roleCode2 = this.props.dashboardPage.role.roles.find(item => item.codeModleFunction === "TakeLeave" );
