...
export function* fetchAllLowerLimitProduct() {
  ...
  try {
    ...
    if (data) {
      yield put(getAllLowerLimitProductSuccess(data.count));
    } else {
...
export function* fetchAllUpperLimitProduct() {
  ...
  try {
    ...
    if (data) {
      yield put(getAllUpperLimitProductSuccess(data.count));
    } else {
...
export function* getallOrg() {
  try {
    ...
    if (data) {
      yield put(getallOrgSuccess(data));
    } else {
...
export default function* stockPageSaga() {
  ...
  yield takeLatest(GET_ALL_PRODUCT, getallOrg);
