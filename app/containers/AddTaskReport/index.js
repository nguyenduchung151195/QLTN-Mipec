...
import { API_REPORT_TASK_PROCESS } from '../../config/urlConfig';
...
const GridList = React.memo(({ reload, openTask, filter, openBusiness, modalRequiredFilter, modalFilter }) => {
  ...
  return (
    <GridLife item md={12}>
      <List
        ...
        tree
        apiUrl={`${API_REPORT_TASK_PROCESS}`}
        isReport={true}
        reload={0}
        code="Task"
        exportExcel
