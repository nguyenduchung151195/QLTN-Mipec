...
import { API_REPORT, API_REPORT_RECEIVABLES, API_SALES_MANAGEMENT, API_TOP_SALES_CUSTOMER, API_TOP_SALES_PRODUCTS } from '../../config/urlConfig';
...
export class AddSalesManager extends React.Component {
  ...
  render() {
    const { addSalesManager, profile, sale } = this.props;
