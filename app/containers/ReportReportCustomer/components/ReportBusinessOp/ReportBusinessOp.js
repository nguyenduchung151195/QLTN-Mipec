  ...
  const handleCloseExcel = payload => {
    ...
    switch (type) {
      case 'PDF':
        ...
        const content = tableToPDF('excel-table-bos-report');
        setHtml(e => [...e, { content, pageNumber }]);
        setHtmlTotal(totalPage);
        break;
      default:
        tableToExcel('excel-table-bos-report', 'W3C Example Table');
    }
  ...
  return (
    <React.Fragment>
      <Grid container spacing={16}>
        <Grid xs={12}>
          <Typography align="center" variant="h5" style={{ marginTop: 30 }}>BÁO CÁO THỐNG KÊ CƠ HỘI KINH DOANH</Typography>
