...
export class BoDialog extends React.Component {
      ...
      <div>
        ...
        >
          <CustomAppBar
            ...
            onGoBack={() => this.props.handleClose()}
            onSubmit={() => {
  ...
  addItemExpenses = () => (
    <Add style={{ color: 'white' }} onClick={() => this.props.mergeData({ openDrawerExpenses: true, id: 'add' })}>
      Open Menu
    </Add>
  );

  addItemTrading = () => (
    <Add style={{ color: 'white' }} onClick={() => this.props.mergeData({ openDrawerExpenses: true })}>
      Open Menu
    </Add>
  );
  ...
  onSaveSales = () => {
    ...
    const data = {
      ...
      salesman: boDialog.profile ? { name: boDialog.profile.name, employeeId: boDialog.profile._id } : null,
