...
import {
  ...
  POST_PROJECT_CURRENT_FAIL,
  POST_PROJECT_CURRENT_SUCCESS,
} from './constants';
...
export function postProjectFail() {
  return {
    type: POST_PROJECT_CURRENT_FAIL,
  };
}
export function postProjectSuccess() {
  return {
    type: POST_PROJECT_CURRENT_SUCCESS,
  };
}
...
export function putProjectFail() {
  return {
