  ...
  render() {
    ...
    return (
      <div>
          ...
          <Paper style={{ width: '100%', padding: '20px' }}>
            <Grid item container md={12}>
              ...
              {Number(this.props.deliveryPage.tab) === 0 ? (
                <Grid item md={5} style={{ marginTop: '5px' }}>
                  <TextField
                    label="Ngày bắt đầu"
                    name="dayStart"
                    type="date"
            ...
            <Grid item md={12} container>
              <Grid item md={6} container style={{ marginTop: '10px' }}>
                <Tabs value={valueOfTab} onChange={this.handleChangeTab} indicatorColor="primary" textColor="primary" variant="fullWidth">
                  <Tab label="Tất cả" />
                  <Tab label="Giao hàng" />
                  <Tab label="Nhận hàng" />
                </Tabs>
        ...
        <Dialog fullWidth="md" open={this.state.open} onClose={this.handleClose} aria-labelledby="responsive-dialog-title">
