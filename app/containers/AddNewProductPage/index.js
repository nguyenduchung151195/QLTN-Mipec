...
import { getTagsAct, addNewProductAct, resetNoti } from './actions';
...
export class AddNewProductPage extends React.Component {
  ...
  render() {
    ...
    const { classes, theme, addNewProductPage, intl, dashboardPage } = this.props;
          ...
          <Grid item xs={12} sm={12} md={12} lg={12}>
            <Paper className={classes.paper}>
              ...
              >
                ...
                <TabContainer dir={theme.direction}>
                  {/* COMPONENT CHA - GỌI COMPONENT CON + cha lấy state của con */}
                  <PricePolicy
                ...
                <TabContainer dir={theme.direction}>
                  <CustomSellingPoint
                    ...
                    name2Title={this.state.name2Title}
                    getValid={valid => {
                      this.setState({ sellingPointValid: valid });
                    }}
                  />
                </TabContainer>
                <TabContainer dir={theme.direction}>
  ...
  handleSubmit = () => {
    ...
    if (Object.keys(productInfo).length !== 0) {
      ...
      const pricePolicyRaw = {
        ...
        priceLadderList: pricePolicy.data.priceLadderList,
        agentPrice,
        taxs,
      };
      const sellingPoint = [];
      ...
      const body = {
        ...
        serials,
        origin,
        description: productInfo.data.describe,
      ...
      if (keysMessage.length === 0) {
        this.props.onAddNewProduct(body);
      }
      else {
        this.props.onChangeSnackbar({ status: true, message: messages[`${keysMessage[0]}`], variant: 'error' });
      }
