...
export class ConfigTask extends React.Component {
  ...
  componentWillReceiveProps(props) {
    this.setState({ color: props.configTask.color });
  }
      ...
      <div>
        ...
        <Dialog onSave={this.onSave} onClose={() => this.props.mergeData({ dialogKanban: false })} open={dialogKanban}>
          <TextField
            fullWidth
            id="standard-name"
            label={intl.formatMessage(messages.tentrangthai || { id: 'tentrangthai', defaultMessage: 'Tên trạng thái' })}
          ...
          <TextField
            ...
            type="color"
            onChange={e => {
              this.props.mergeData({ color: e.target.value });
            }}
          />
        </Dialog>
      </div>
