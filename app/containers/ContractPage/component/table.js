...
const rows = [
  { id: 'id', numeric: false, disablePadding: true, label: 'Mã' },
  { id: 'name', numeric: false, disablePadding: true, label: 'Tên' },
  { id: 'guess', numeric: false, disablePadding: true, label: 'Khách hàng' },
  { id: 'numberOfOrder', numeric: false, disablePadding: true, label: 'Số đơn hàng' },
  { id: 'signDate', numeric: false, disablePadding: true, label: 'Ngày kí' },
  { id: 'status', numeric: false, disablePadding: true, label: 'Trạng thái' },
  { id: 'files', numeric: false, disablePadding: true, label: 'Files' },
  ...
  render() {
    ...
    return (
      <Paper className="mb-0">
        <EnhancedTableToolbar {...this.props} numSelected={selected.length} />
        <div style={{ overflowX: 'auto' }}>
          <Table style={{ width: '100%' }} aria-labelledby="tableTitle">
            <EnhancedTableHead
                ...
                .map(n => {
                  ...
                  return (
                    <TableRow hover role="checkbox" aria-checked={isSelected} tabIndex={-1} key={n.name} selected={isSelected}>
                      ...
                      <TableCell align="center">{n.guess ? n.guess : 'No Infor'}</TableCell>
                      <TableCell align="center">{n.orderNumber}</TableCell>
                      <TableCell align="center">{moment(n.signDate).toString()}</TableCell>
                      <TableCell align="center">{n.status}</TableCell>
                      <TableCell align="center">{n.otherRequire.fileName}</TableCell>
                      ...
                      <TableCell align="center">
                        ...
                        <IconButton
                          aria-label="Delete"
                          onClick={() => {
                            this.props.callBack('edit-contract', n);
                          }}
                        >
