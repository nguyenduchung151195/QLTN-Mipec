...
import { DEFAULT_ACTION, RESET_NOTI, GET_ALL_ITEMS, GET_ALL_ITEMS_SUCCESS, GET_ALL_ITEMS_FAILED ,CHANGE_TAB, MERGE_DATA} from './constants';
...
export function mergeStockImportPage(data) {
  return {
    type: MERGE_DATA,
    data,
  };
