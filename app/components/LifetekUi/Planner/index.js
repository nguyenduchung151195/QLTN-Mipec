...
function Join(props) {
  ...
  switch (length) {
    ...
    default:
      return (
        <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginLeft: 7 }}>
          <AvatarItem alt="Nguyễn văn A" key={joins[0]._id} src={joins[0].avatar} />
          <AvatarItem alt="Nguyễn văn A" key={joins[1]._id} src={joins[1].avatar} />
          <AvatarItem alt="Nguyễn văn A" key={joins[2]._id} src={joins[2].avatar} />
