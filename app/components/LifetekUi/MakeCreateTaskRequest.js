...
export default function MakeCreateTaskRequest(props) {
  ...
  return (
    <div>
      ...
      <SwipeableDrawer anchor="right" onClose={() => setOpenCreateTask(false)} open={openCreateTask} width={window.innerWidth - 260}>
        <AddProjects
          id="add"
          isCreateTask
          data={{
