...
class HeaderLinks extends React.Component {
  ...
  componentWillUnmount() {
    if (this.props.socket) this.props.socket.off('chat');
  }
  ...
  componentWillReceiveProps(props) {
    ...
    this.state.notifications = props.notifications && props.notifications.data;
  ...
  render() {
    ...
    const currentAvatar = this.props.dashboardPage && this.props.dashboardPage.profile.avatar;
        ...
        <div className="d-inline position-relative">
          ...
          {this.state.open === true ? (
            <ClickAwayListener onClickAway={() => this.setState({ open: false })}>
              <div style={{ position: 'absolute', left: -300, maxHeight: 500, overflow: 'auto', margin: '8px' }} className={classes.dropdown}>
                <Grow
                  in={open}
                            ...
                            <Grid container justify="center" alignItems="center">
                              ...
                              <Grid item sm="10" style={{ width: 250 }}>
                                ...
                                <p style={{ fontSize: 12 }} className="mb-0">
                                  <AlarmOn style={{ fontSize: 16 }} color="primary" />{' '}
                                  {moment(item.date)
                                    .utc()
