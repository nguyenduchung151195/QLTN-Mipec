        ...
        <ExpansionPanel defaultExpanded>
          ...
          <ExpansionPanelDetails>
            <SortableContainer collection={2} onSortEnd={this.onSortEnd} useDragHandle>
              ...
              <Button variant="outlined" color="primary" className={classes.button} onClick={() => this.handleClickOpen('openAdd', 2)}>
                Thêm mới
              </Button>
            </SortableContainer>
          </ExpansionPanelDetails>
            ...
            <ExpansionPanel defaultExpanded style={{ marginLeft: 10 }}>
              ...
              <ExpansionPanelDetails>
                <SortableContainer onSortEnd={this.onSortEnd} collection={4} useDragHandle>
                  ...
                  <Button variant="outlined" color="primary" className={classes.button} onClick={() => this.handleClickOpen('openAdd', 4)}>
                    Thêm mới
                  </Button>
                </SortableContainer>
              </ExpansionPanelDetails>
