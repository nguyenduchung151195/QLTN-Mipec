...
class Category extends React.Component {
  ...
  handleSubmitForm = () => {
    ...
    if (!this.state.isEditting) {
      this.props.callBack('add-category', this.state.dialogData);
    } else {
      this.props.callBack('update-category', this.state.dialogData);
    }
  };
    ...
    >
      ...
      <Button
        ...
        onClick={() => {
          ...
          if (r) {
            this.props.callBack('delete-category', item);
          }
        }}
      >
        [Xóa]
