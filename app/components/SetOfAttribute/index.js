...
import { initialDate, noSpaceStartAndEnd } from 'config/config';
                            ...
                            return (
                              <Grid item md={6} key={control.id}>
                                ...
                                {/* <DatePicker
                                  ...
                                  disableFuture
                                  label={`${control.name}`}
                                  value={this.state.ngaygapdautien}
                                  onChange={e => {
                                    this.setState({ ngaygapdautien: e.target.value });
                                    this.changeValue(control.id, e);
                                  }}
                                /> */}
                              </Grid>
                            );
