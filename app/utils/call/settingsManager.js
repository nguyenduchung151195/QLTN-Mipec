...
const DEFAULT_SETTINGS = JSON.parse(
  '{ "display_name": "thang", "uri": "sip:101@lifetekhcm026.ccall.vn", "password": "YU7iYj^hWJ", "socket": { "uri": "wss://sbcwrtchcm.ccall.vn:8080", "via_transport": "auto" }, "registrar_server": null, "contact_uri": null, "authorization_user": null, "instance_id": null, "session_timers": false, "use_preloaded_route": false, "pcConfig": { "rtcpMuxPolicy": "negotiate", "iceServers": [{ "urls": ["stun:stun.l.google.com:19302"] }] }, "callstats": { "enabled": false, "AppID": null, "AppSecret": null } }',
);
...
if (window.SETTINGS) {
  ...
  // settings = deepmerge(window.SETTINGS, settings || {}, { arrayMerge: (destinationArray, sourceArray) => sourceArray });
}
